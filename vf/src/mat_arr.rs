...
use crate::{_append, _concat, _zip_arr, append, map_arr, mat_slice, VectorField, VectorFieldMul, VectorFieldMulAssign, xy_z3, xyz_w4, zip_arr};
use crate::arr_concat::concat;
use crate::init::uninit_array2;
...
pub fn mat3_to_mat4<A:Clone>(mat:[[A;3];3], fill_value:A)->[[A;4];4]{
    let [r0,r1,r2] = mat;
    [
        xyz_w4(r0,fill_value.clone()),
        xyz_w4(r1,fill_value.clone()),
        xyz_w4(r2,fill_value.clone()),
        [fill_value.clone(),fill_value.clone(),fill_value.clone(),fill_value.clone()]
    ]
}
